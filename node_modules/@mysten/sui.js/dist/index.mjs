...
var PaginatedEvents = object3({
  ...
  nextCursor: union3([EventId, literal3(null)]),
...
var SuiTransaction = union4([
  ...
  object4({ Publish: SuiMovePackage }),
  object4({ MakeMoveVec: tuple([nullable(string4()), array3(SuiArgument)]) })
]);
var SuiCallArg = union4([
  object4({
    type: literal4("pure"),
  ...
  object4({
    ...
    objectType: literal4("immOrOwnedObject"),
    objectId: ObjectId,
    version: SequenceNumber,
    digest: ObjectDigest
  }),
  object4({
    type: literal4("object"),
    objectType: literal4("sharedObject"),
    objectId: ObjectId,
...
var SuiTransactionBlockKind = union4([
  assign2(SuiChangeEpoch, object4({ kind: literal4("ChangeEpoch") })),
  assign2(
    SuiConsensusCommitPrologue,
    object4({
      kind: literal4("ConsensusCommitPrologue")
    })
  ),
  assign2(Genesis, object4({ kind: literal4("Genesis") })),
  assign2(
    ProgrammableTransaction,
    object4({ kind: literal4("ProgrammableTransaction") })
  )
]);
var SuiTransactionBlockData = object4({
  // Eventually this will become union(literal('v1'), literal('v2'), ...)
  messageVersion: literal4("v1"),
...
var PaginatedTransactionResponse = object4({
  ...
  nextCursor: union4([TransactionDigest, literal4(null)]),
...
import { literal as literal5, number as number5, object as object5, string as string5, union as union5 } from "superstruct";
...
var CoinMetadataStruct = object5({
  ...
  symbol: string5(),
  description: string5(),
  iconUrl: union5([string5(), literal5(null)]),
  id: union5([ObjectId, literal5(null)])
});
var Coin = class {
  static isCoin(data) {
...
// src/types/faucet.ts
import { array as array4, nullable as nullable2, number as number6, object as object6, string as string6 } from "superstruct";
...
var StakeObject = object8({
  ...
  principal: number8(),
  status: union7([literal7("Active"), literal7("Pending"), literal7("Unstaked")]),
...
var CommitteeInfo = object8({
  ...
  validators: optional4(array6(tuple2([AuthorityName, number8()])))
});
var SuiValidatorSummary = object8({
  ...
  nextEpochProtocolPubkeyBytes: nullable3(string8()),
  nextEpochProofOfPossession: nullable3(string8()),
  nextEpochNetworkPubkeyBytes: nullable3(string8()),
  nextEpochWorkerPubkeyBytes: nullable3(string8()),
  nextEpochNetAddress: nullable3(string8()),
  nextEpochP2pAddress: nullable3(string8()),
  nextEpochPrimaryAddress: nullable3(string8()),
  nextEpochWorkerAddress: nullable3(string8()),
  votingPower: number8(),
  gasPrice: number8(),
  ...
  stakingPoolActivationEpoch: nullable3(number8()),
  stakingPoolDeactivationEpoch: nullable3(number8()),
...
var CoinStruct = object9({
  ...
  digest: TransactionDigest,
  balance: number9(),
  lockedUntilEpoch: nullable4(number9()),
  previousTransaction: TransactionDigest
});
var PaginatedCoins = object9({
  data: array7(CoinStruct),
  nextCursor: union8([ObjectId, literal8(null)]),
...
var CheckpointPage = object10({
  ...
  nextCursor: union9([string10(), literal9(null)]),
...
import { any as any7, is as is9, array as array13, string as string16 } from "superstruct";
...
// src/builder/Transactions.ts
var option = (some) => union11([object13({ None: literal12(null) }), object13({ Some: some })]);
var TransactionBlockInput = object13({
  kind: literal12("Input"),
  index: integer2(),
  value: optional8(any6()),
  type: optional8(union11([literal12("pure"), literal12("object")]))
});
var TransactionArgumentTypes = [
  TransactionBlockInput,
  object13({ kind: literal12("GasCoin") }),
  object13({ kind: literal12("Result"), index: integer2() }),
  object13({
    kind: literal12("NestedResult"),
    index: integer2(),
    resultIndex: integer2()
  })
];
var TransactionArgument = union11([...TransactionArgumentTypes]);
var ObjectTransactionArgument = union11([...TransactionArgumentTypes]);
ObjectTransactionArgument[TRANSACTION_TYPE] = {
  kind: "object"
};
var PureTransactionArgument = (type) => {
  const struct = union11([...TransactionArgumentTypes]);
...
var TransactionType = union11([...TransactionTypes]);
...
// src/builder/Inputs.ts
var ObjectArg = union12([
  object14({ ImmOrOwned: SuiObjectRef }),
  object14({
    Shared: object14({
      objectId: string14(),
      initialSharedVersion: union12([integer3(), string14()]),
      mutable: boolean9()
    })
  })
]);
...
var BuilderCallArg = union12([PureCallArg, ObjectCallArg]);
var Inputs = {
  Pure(data, type) {
    return {
      Pure: Array.from(
...
var TransactionExpiration = optional9(
  nullable5(
    union13([
      ...
      object15({ None: union13([literal13(true), literal13(null)]) })
    ])
  )
);
...
prepare_fn = async function({ provider, onlyTransactionKind }) {
  ...
  if (objectsToResolve.length) {
    ...
    objectsToResolve.forEach(({ id, input, normalizedType }) => {
      const object16 = objectsById.get(id);
      const initialSharedVersion = getSharedObjectInitialVersion(object16);
      if (initialSharedVersion) {
        ...
        input.value = Inputs.ObjectRef(getObjectReference(object16));
      }
    });
  }
  if (!onlyTransactionKind) {
...
var JsonRpcProvider = class {
  ...
  async multiGetTransactionBlocks(input) {
    ...
    return await this.client.requestWithType(
      ...
      array13(SuiTransactionBlockResponse),
      this.options.skipDataValidation
    );
  }
  ...
  switch (signature.signatureScheme) {
    ...
    case "Secp256k1":
      return secp2.verify(
        ...
        await secp2.utils.sha256(digest),
        signature.pubKey.toBytes()
      );
    default:
      throw new Error(
