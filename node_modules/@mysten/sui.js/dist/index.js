...
__export(src_exports, {
  ...
  assert: () => import_superstruct20.assert,
  bcs: () => bcs,
...
var PaginatedObjectsResponse = (0, import_superstruct2.object)({
  ...
  nextCursor: (0, import_superstruct2.optional)(CheckpointedObjectId),
...
var PaginatedEvents = (0, import_superstruct3.object)({
  ...
  nextCursor: (0, import_superstruct3.union)([EventId, (0, import_superstruct3.literal)(null)]),
...
var SuiTransaction = (0, import_superstruct4.union)([
  ...
  (0, import_superstruct4.object)({ Publish: SuiMovePackage }),
...
var PaginatedTransactionResponse = (0, import_superstruct4.object)({
  ...
  nextCursor: (0, import_superstruct4.union)([TransactionDigest, (0, import_superstruct4.literal)(null)]),
...
var CoinMetadataStruct = (0, import_superstruct5.object)({
  ...
  iconUrl: (0, import_superstruct5.union)([(0, import_superstruct5.string)(), (0, import_superstruct5.literal)(null)]),
  id: (0, import_superstruct5.union)([ObjectId, (0, import_superstruct5.literal)(null)])
});
var Coin = class {
  static isCoin(data) {
...
var CommitteeInfo = (0, import_superstruct8.object)({
  ...
  validators: (0, import_superstruct8.optional)((0, import_superstruct8.array)((0, import_superstruct8.tuple)([AuthorityName, (0, import_superstruct8.number)()])))
});
...
var CheckpointPage = (0, import_superstruct10.object)({
  ...
  nextCursor: (0, import_superstruct10.union)([(0, import_superstruct10.string)(), (0, import_superstruct10.literal)(null)]),
...
var DynamicFieldPage = (0, import_superstruct12.object)({
  ...
  nextCursor: (0, import_superstruct12.union)([ObjectId, (0, import_superstruct12.literal)(null)]),
...
var JsonRpcProvider = class {
  ...
  async getAllBalances(input) {
    ...
    return await this.client.requestWithType(
      "suix_getAllBalances",
      [input.owner],
      (0, import_superstruct19.array)(CoinBalance),
      this.options.skipDataValidation
    );
  }
  /**
  ...
  async call(method, args) {
    ...
    if ((0, import_superstruct19.is)(response, ErrorResponse)) {
      throw new RPCError({
        req: { method, args },
        code: response.error.code,
        data: response.error.data,
  ...
  async multiGetObjects(input) {
    ...
    return await this.client.requestWithType(
      ...
      (0, import_superstruct19.array)(SuiObjectResponse),
      this.options.skipDataValidation
    );
  }
  /**
  ...
  async multiGetTransactionBlocks(input) {
    ...
    return await this.client.requestWithType(
      ...
      (0, import_superstruct19.array)(SuiTransactionBlockResponse),
      this.options.skipDataValidation
    );
  }
  ...
  async getStakes(input) {
    ...
    return await this.client.requestWithType(
      "suix_getStakes",
      [input.owner],
      (0, import_superstruct19.array)(DelegatedStake),
      this.options.skipDataValidation
    );
  }
  /**
