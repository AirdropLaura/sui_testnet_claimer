...
export declare class JsonRpcProvider {
    ...
    getAllCoins(input: {
        owner: SuiAddress;
    } & PaginationArguments): Promise<PaginatedCoins>;
    /**
    ...
    getOwnedObjects(input: {
        owner: SuiAddress;
    } & PaginationArguments & SuiObjectResponseQuery): Promise<PaginatedObjectsResponse>;
    /**
     ...
     */
    queryTransactionBlocks(input: SuiTransactionBlockResponseQuery & PaginationArguments & OrderArguments): Promise<PaginatedTransactionResponse>;
    ...
    } & PaginationArguments & OrderArguments): Promise<PaginatedEvents>;
    /**
    ...
    getDynamicFields(input: {
        ...
        parentId: ObjectId;
    } & PaginationArguments): Promise<DynamicFieldPage>;
    /**
